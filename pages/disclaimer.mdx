...
export default ({ children }) => <LegalLayout>{children}</LegalLayout>;
...
- **Company** (referred to as either "the Company", "We", "Us" or "Our" in this Disclaimer) refers to Edvaldo Gjonikaj Website.
- **Service** refers to the Website.
- **You** means the individual accessing the Service, or the company, or other legal entity on behalf of which such individual is accessing or using the Service, as applicable.
- **Website** refers to Edvaldo Gjonikaj Website, accessible from [https://edvaldogjonikaj.me](https://edvaldogjonikaj.me)
...
- By email: danielwirtzx@gmail.com
